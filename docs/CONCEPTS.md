...
| L4 | Autonomous exploration | shipped (Phase 6 P0) | gap tracker, digest push, curiosity clustering, user-approved crawl queue, fact→gap matching (active suggestion), 16-tool MCP agent surface |
